    ...
    <>
      <div className="mx-[18px] mt-[402px] h-[308px] w-auto desktop:mx-0 desktop:mt-[80px] desktop:w-[476px]">
        <div className="align-items flex flex-col justify-start">
          ...
          <h1 className="text-34 font-bold leading-[1.1] tracking-[-0.02em] desktop:mb-[24px] desktop:text-50">
            Zadbaj o komfort swojego pupila
          </h1>
          <p className="desktop:tracking-0 my-[16px] block text-20 font-normal leading-[1.3] tracking-[-0.02em] desktop:hidden desktop:text-[22px] desktop:leading-[1.5]">
        ...
        <div className="mt-[20px] flex flex-col items-center justify-center gap-[26px] desktop:items-start desktop:justify-end desktop:mt-0">
          <div className="h-auto w-[230px] text-center">
            <p className="block desktop:hidden text-20 font-normal leading-[1.3] tracking-[-0.02em] desktop:text-[22px]">
