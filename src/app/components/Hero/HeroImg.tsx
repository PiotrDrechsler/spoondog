...
export const HeroImg = () => {
  return (
    <div className="relative right-0 top-[80px] h-full max-h-[700px]">
      <div className="absolute right-0 h-[288px] w-[306px] rounded-hero-radius bg-hero-bg shadow-hero-shadow tablet:h-[450px] tablet:w-[450px] desktop:h-[730px] desktop:w-[700px] xl:h-[900px] xl:w-[900px] xl:right-[50px] xl:rounded-hero-radius-big xxl:right-[150px]">
