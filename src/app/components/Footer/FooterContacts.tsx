export const FooterContacts = () => {
  return (
    <div className="flex flex-col w-full text-14 leading-[21px] font-semibold  desktop:max-w-[203px]">
      <h4 className=" leading-6 mb-3 text-base desktop:mb-6">Kontakt</h4>
      <p>Katarzyna Bober</p>
