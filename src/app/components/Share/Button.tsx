...
const Button = () => {
  return (
    <a
      href="/"
      className="group flex w-full h-full items-center gap-[10px] rounded-full bg-gradient-btn px-[24px] py-[12px] shadow-button-shadow transition duration-300 ease-in-out hover:scale-[1.05] focus:scale-[1.05] group-hover:text-violet group-focus:text-violet lg:px-[32px] lg:py-[16px]"
    >
