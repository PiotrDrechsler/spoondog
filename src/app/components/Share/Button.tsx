...
const Button: React.FC<ButtonProps> = ({ href, content }) => {
  return (
    ...
    >
      <span className="whitespace-nowrap text-sm font-medium leading-[1.5] transition duration-300 ease-in-out group-hover:text-violet group-focus:text-violet tablet:text-base desktop:text-lg">
        {content}
      </span>
