...
const Button: React.FC<ButtonProps> = ({ href }) => {
  return (
    <a
      href={href}
      className="shadow-button-shadow bg-gradient-btn group-hover:text-violet group-focus:text-violet group flex max-w-[219px] items-center gap-[10px] rounded-full px-[24px] py-[12px] transition duration-300 ease-in-out hover:scale-[1.05] focus:scale-[1.05]"
    >
