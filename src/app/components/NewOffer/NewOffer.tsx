...
export const NewOffer = () => {
  return (
    <section id="newOffer" className="pt-[10px]">
      <Container>
        <div className="mx-auto my-[12px] w-full max-w-[364px] rounded-radius24 border-2 bg-cream py-[40px] shadow-boxes-shadow desktop:my-0 desktop:max-w-[1340px] desktop:px-[100px]">
