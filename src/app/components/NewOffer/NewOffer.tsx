import newOfferBefore from "../../assets/newOfferBefore.png";
import newOfferAfter from "../../assets/newOfferAfter.png";
...
export const NewOffer = () => {
  return (
    <section id="newOffer" className="pt-[70px] desktop:pt-[88px]">
      <div className="shadow-newOffer-shadow mx-auto my-[12px] w-full max-w-[364px] rounded-contact-radius border-2 bg-cream py-[40px] desktop:my-0 desktop:max-w-[1340px] desktop:px-[100px]">
        <div className="flex flex-col items-center desktop:flex-row desktop:justify-center desktop:space-x-[140px]">
          ...
          {/* Right column - Images */}
          <div className="relative mx-auto mb-[36px] h-[300px] w-[327px] desktop:mb-0 desktop:h-[432px] desktop:w-[510px] desktop:space-x-[140px]">
            <NewOfferImg
