...
export const NewOffer = () => {
  return (
    <section id="newOffer" className="pt-[10px]">
      <Container>
        <div className="mx-auto my-[12px] w-full max-w-[364px] rounded-radius24 border-2 bg-cream py-[40px] shadow-boxes-shadow tablet:max-w-[100vw] desktop:my-0 desktop:max-w-[1340px] desktop:px-[100px]">
          <div className="tablet:space-x-auto flex flex-col items-center tablet:mx-[10px] tablet:flex-row tablet:justify-center desktop:flex-row desktop:justify-center desktop:space-x-[140px]">
