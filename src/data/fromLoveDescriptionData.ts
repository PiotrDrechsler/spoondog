export const contentData = {
  ...
  adoptionEncouragement:
    "Aby zachęcić do adopcji oferuję darmowe strzyżenie i kąpiel dla każdego psiaka, adoptowanego ze schroniska w Opolu (należy pokazać umowę adopcyjną).",
  sections: [
    {
      paragraphs: [
        "Dla odmiany nie hoduję psów, nie jestem zwolenniczką bezmyślnego rozmnażania, chciałabym móc zamknąć wszystkie pseudohodowle, gdzie zwierzęta doznają samych cierpień, służą za maszynki do robienia pieniędzy. Trzymane są w fatalnych warunkach, często bez kontaktu z ludźmi, rodzą dwa razy do roku, a jak są już stare i niepotrzebne, lądują w schroniskach lub giną. Szczeniaki z takich miejsc nie potrafią się odnaleźć w nowym domu, często do końca życia są zlęknione i nieufne, a nawet agresywne. Socjalizacja jest ważna od samego początku. Dlatego zachęcam do przemyślanych decyzji, kupna szczeniaków z prawdziwych hodowli, gdzie psiak posiada metryczkę. ",
        "Szczególnie namawiam do adopcji, każda rasa posiada swoją fundację. Co prawda nie zawsze są to psy rasowe, często chorei po przejściach, ale swoim małym serduszkiem kochają naprawdę mocno.Są wdzięczne i wierne",
        "Pamiętajmy jednak, że adopcja psa jest wspaniałym gestem dobrego człowieka, ale przemyślana adopcja jest czymś więcej, bo przejawia odpowiedzialność tego dobrego człowieka.",
        "",
      ],
    },
    {
      paragraphs: [
        ...
        "Pamiętajmy także, że żaden pies nie jest od razu idealnym kompanem trzeba go wszystkiego nauczyć co wymaga czasu i cierpliwości.",
      ],
    },
  ],
  finalQuote:
