  ...
  return (
    <section className="h-full w-full pb-[40px] pt-[100px] desktop:pb-[226px] desktop:pt-[120px]">
      <Container>
        ...
        <div className="w-full rounded-radius24 border-[1px] border-black bg-cream px-[16px] py-[24px] text-14 leading-[21px] shadow-reg-shadow desktop:p-[60px] desktop:text-18 desktop:leading-[27px]">
